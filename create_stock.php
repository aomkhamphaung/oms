...
$product = $stockController->getProduct();
...
if (isset($_POST['add'])) {
    ...
    if (!$error) {
        $result = $stockController->addStock($products, $price, $qty, $date);
        if ($result) {
                    ...
                    <form action="" method="post">
                        <div class="mt-3">
                            ...
                            <select name="product" id="product" class="form-control">
                                ...
                                for ($index = 0; $index < count($product); $index++) {
                                    echo "<option value = '" . $product[$index]['id'] . " '>" . $product[$index]['name'] . "</option>";
                                }
                                ?>
                            </select>
                        </div>
                        <div class="mt-3">
                            <label for="price" class="form-label">Unit pirce</label>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="date" name="date" id="date" class="form-control"
                                placeholder="Enter product's arriving date">
                        </div>
