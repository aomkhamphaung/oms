...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <a href="create_category.php" class="btn btn-primary mb-3">Add new category</a>
                </div>
            </div>
                        ...
                        <tbody id='tbody'>
                            <form action="" method="post">
                                ...
                                for ($row = 0; $row < count($result_page); $row++) {
                                    ...
                                    echo "<td id = '" . $result_page[$row]['id'] . "'> <a href = 'edit_category.php?id=" . $result_page[$row]['id'] . " ' class = 'btn btn-warning mr-3'> Edit </a> <a class = 'btn btn-danger delete'>Delete</a>";
                                    echo "</tr>";
                                }
                                ?>
                            </form>
                ...
                <div class="col-md-10">
                    <nav aria-label="...">
                        <ul class="pagination">
                            ...
                            <?php
                            $pages = ceil(count($categories) / $item_per_page);
                            $previous = $page - 1;
                            $next = $page + 1;
                            ...
                            if ($page <= 1) {
                                ...
                                <a class="page-link" href="categories.php?page=' . $previous . '">Previous</a>
                            </li>';
                            }
